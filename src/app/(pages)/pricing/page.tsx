         ...
         <main className="pricing">
           <Navbar/>
            ...
            <Grid paddingX={3} paddingY={6} component={"div"} className="grid_1" justifyContent={"center"} alignItems={"center"} textAlign={"center"} >
                ...
                <Button color="#fff" className="button" backgroundColor="var(--secondary-color)" hoverStyle={{color:"var(--secondary-color)",bgcolor:"#F4F4F4",border:"1px solid var(--secondary-color)"}} to={Route.SIGNUP}>Start signing of</Button>
            </Grid>
            {/* --------------------------------- */}
            ...
            <Card height="fit-content" style={{maxWidth:"100%"}} borderColor="#43434380" borderWidth={1} borderRadius={20} padding={20}>
             ...
             <Button hoverStyle={{color:"var(--secondary-color)",bgcolor:"#fff",
             border:"1px solid var(--secondary-color)"}} style={{margin:"45px auto 20px auto"}} 
             width={"90%"} height={"47px"} color="#fff" borderRadius={"19px"} 
