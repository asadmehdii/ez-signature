...
const RightsTableData = [
    {
        ...
        means: "You have the right to be provided with clear, transparent and easily understandable information about how we use your personal data and what your rights are. This is why we are providing you this privacy notice.",
    },
    {
        ProtectRight: "Right of access",
        means: "You have the right to obtain access to your personal data we process and certain other information (similar to that provided in this privacy notice).You may ask for:",
        items: [
    ...
    },
    {
        ...
        means: "You are entitled to have your information corrected if it is inaccurate or incomplete.If you would like us to do this, please contact us. ",
    },
    {
        ProtectRight: "Rights to ask us to stop contacting you with direct marketing",
