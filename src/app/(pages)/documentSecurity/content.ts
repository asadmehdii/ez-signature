...
const CarouselData = [

  {
    ...
    text:"Securely store your documents after completion in your Xodo Sign account, schedule them to auto-expire, export them to a private location or permanently remove them from Xodo Sign systems."
    },
