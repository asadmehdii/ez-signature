...
const CarouselData = [
  ...
  {
    image:Assests.DocumentManageScroll.src,
    heading:"Document Management & Security",
    feature:"Document Management & Security",
    text:"Securely store your documents after completion in your Ez Sign account, schedule them to auto-expire, export them to a private location or permanently remove them from Ez Sign systems."
  },
  {
