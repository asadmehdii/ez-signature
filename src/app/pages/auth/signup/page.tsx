    ...
    return(
        ...
        <Box m={"auto"}>
          ...
          <Box display={"flex"} flexDirection={"column"} justifyContent={"center"} alignItems={"center"} my={1} maxWidth={"450px"}>
             ...
             <Text color="#cdcdcd" fontSize="14px" fontWeight="500" marginTop={20}>Alread have an account? <Link href={Route.LOGIN} style={{color:"var(--secondary-color)",cursor:'pointer'}}>Login</Link></Text>
          </Box>
          </Box>
        </Box>
         <Box component={"img"} width={{xs:"90%",sm:"430px",lg:"auto"}} src={Assests.SignUpImage.src} alt="img_here"/>
        </Grid>
        </ContentBox>
        </main>
    )
