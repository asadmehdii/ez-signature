  ...
  return (
    <main className="home">
      ...
      <Grid component={"div"} className="grid_5" padding={3}>
        <Text fontSize="55px" fontWeight="800">
          Discover how EzSignature can help you run your business
        </Text>
        <Grid container gap={2} alignItems={"center"} marginY={4}>
          <Image style={{width:'156px',height:"100px",objectFit:"contain"}} src={BusinessImage_1} alt="image_here" />
          <Image style={{width:'166px',height:"138px",objectFit:"contain"}} src={BusinessImage_2} alt="image_here" />
          <Image style={{width:'156px',height:"100px",objectFit:"contain"}} src={BusinessImage_3} alt="image_here" />
          <Image style={{width:'156px',height:"100px",objectFit:"contain"}} src={BusinessImage_4} alt="image_here" />
          <Image style={{width:'156px',height:"100px",objectFit:"contain"}} src={BusinessImage_5} alt="image_here" />
          <Image style={{width:'156px',height:"100px",objectFit:"contain"}} src={BusinessImage_6} alt="image_here" />
          <Image style={{width:'156px',height:"100px",objectFit:"contain"}} src={BusinessImage_7} alt="image_here" />
        </Grid>
