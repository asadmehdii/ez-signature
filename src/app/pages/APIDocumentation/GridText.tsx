...
const GridText:React.FC<props> =({leftChild,rightChild,heading,title,id})=>{
  return(
    <Grid component={"div"} id={id} container  flexDirection={{xs:"column",lg:"row"}} m={0} borderLeft={"1px solid #000000"} width={"100%"}>
        <Box mt={0} boxSizing={"border-box"} width={{xs:"100%",lg:"50%"}}> 
        ...
        {leftChild}
         ...
         <Box boxSizing={"border-box"} border={"1px solid #fff"} borderLeft={0} width={{xs:"100%",lg:"50%"}} bgcolor="#002A1E" mt={0}>
          {rightChild}
        </Box>
    </Grid>
  )
