  ...
  return (
    <Box maxWidth={maxWidth} width={width} mt={mt} mb={mb}>
      <Box display={"flex"} justifyContent={"space-Between"}>
        <Typography sx={[Styles.lableStyle, { ...lableStyle }]} mb={1}>
          {lable} {important && <EmergencyIcon sx={{ fontSize: "8px", mb: 0.7, color: "#ef5350" }} />}
        </Typography>
        {protect &&
          <>
            {hidePassword === "password" ? 
              ...
              (<Text 
                color="var(--lightGray-color)" 
                onClick={() => setHidePassword("password")} 
                style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }} 
                fontSize="18px" 
                fontWeight="600"
              >
      ...
      <TextField
        ...
        onChange={onChange}
        fullWidth
        type={protect ? hidePassword : type}
        variant="outlined"
