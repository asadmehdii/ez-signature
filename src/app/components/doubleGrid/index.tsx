...
const DoubleGrid:React.FC<Props> = ({mt,mb})=> {
  ...
  return (
    ...
    <Box component={"div"} width={{xs:"100%",md:"50%"}} sx={Styles.rightDiv}>
      ...
      <Button sx={{mt:3}} hoverStyle={{color:"var(--secondary-color)",bgcolor:"transparent",border:"1px solid var(--secondary-color)"}} fontSize={20} fontWeight="500" borderRadius={"19px"} width={249} height={69} color="var(--text-color)" backgroundColor="var(--secondary-color)"
      to={Route.CONTACT_US}
      >Contact Us</Button>
      </ContentBox>
    </Box>
    ...
    <ContentBox sx={{display:"flex",justifyContent:"center",flexDirection:"column",gap:2}}>
    <Text fontSize={"38px"} fontWeight="800" color="#fff">Interested in using the Ez Sign API?</Text>
      ...
      <Button fontSize={20} fontWeight="500" hoverStyle={{color:"var(--secondary-color)",bgcolor:"transparent",border:"1px solid var(--secondary-color)"}} borderRadius={"19px"} width={249} height={69} color="var(--text-color)" backgroundColor="var(--secondary-color)"
      to={Route.PRICING}
      >API Pricing Plans</Button>
    </ContentBox>
    </Box>
  </Grid>
  )
